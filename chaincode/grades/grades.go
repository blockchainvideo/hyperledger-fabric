...
func main() {
	err := shim.Start(new(GradeChaincode))
	if err != nil {
		fmt.Printf("Error starting part Trace chaincode: %s", err)
	}
}

func (t *GradeChaincode) Init(stub shim.ChaincodeStubInterface) sc.Response {
	return shim.Success(nil)
}

func (t *GradeChaincode) Invoke(stub shim.ChaincodeStubInterface) sc.Response {
...
func (t *GradeChaincode) initPart(stub shim.ChaincodeStubInterface, args []string) sc.Response {
	var err error
	...
	var user = grade{class, examRegistrationNumber , examName , student,grades}
...
func (t *GradeChaincode) readPart(stub shim.ChaincodeStubInterface, args []string) sc.Response {
...
func (t *GradeChaincode) deletePart(stub shim.ChaincodeStubInterface, args []string) sc.Response {
...
func (t *GradeChaincode) deletePartHelper(stub shim.ChaincodeStubInterface, examRegistrationNumber string) (string, error) {
...
func (t *GradeChaincode) queryAllParts( stub shim.ChaincodeStubInterface) sc.Response {
